...
const deafeatScreen = document.getElementById('game-over-text');
...
var downloadTimer = setInterval(function(){
    ...
    document.getElementById("time-remaining").innerHTML = timeleft + " seconds remaining";
    }
    timeleft -= 1;
}, 1000);

function gameOver(){
    deafeatScreen.classList.add('display');
}
